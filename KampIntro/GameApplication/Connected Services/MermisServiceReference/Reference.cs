...
namespace MermisServiceReference
{
    ...
    public partial class KPSPublicSoapClient : System.ServiceModel.ClientBase<MermisServiceReference.KPSPublicSoap>, MermisServiceReference.KPSPublicSoap
    {
        ...
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        System.Threading.Tasks.Task<MermisServiceReference.TCKimlikNoDogrulaResponse> MermisServiceReference.KPSPublicSoap.TCKimlikNoDogrulaAsync(MermisServiceReference.TCKimlikNoDogrulaRequest request)
        {
            return base.Channel.TCKimlikNoDogrulaAsync(request);
        }
        
        public System.Threading.Tasks.Task<MermisServiceReference.TCKimlikNoDogrulaResponse> TCKimlikNoDogrulaAsync(long TCKimlikNo, string Ad, string Soyad, int DogumYili)
        {
            MermisServiceReference.TCKimlikNoDogrulaRequest inValue = new MermisServiceReference.TCKimlikNoDogrulaRequest();
            inValue.Body = new MermisServiceReference.TCKimlikNoDogrulaRequestBody();
            inValue.Body.TCKimlikNo = TCKimlikNo;
            inValue.Body.Ad = Ad;
            inValue.Body.Soyad = Soyad;
            inValue.Body.DogumYili = DogumYili;
            return ((MermisServiceReference.KPSPublicSoap)(this)).TCKimlikNoDogrulaAsync(inValue);
        }
